...
<body>
    ...
    <div class="p-4">
        ...
        <div class="text-left my-4">
            <a href="quadro?acao=quadros=${quadro.id}" class="mb-4">
                ...
                <form action="quadro" method="post" class="formulario child">
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Digite o título do quadro" name="titulo" required/>
                        </div>
                        <div class="col-6 mb-3">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="textarea" class="form-control" placeholder="Informe uma descrição" name="descricao" required/>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <input type="submit" value="Adicionar quadro" name="quadro" class="btn btn-primary btn-sm mt-4"/>
                    </div>
                </form>
            </div>
        </div>
